...
const milestones = [
  {
    ...
    icon: "🚀", // 실제 개발에서는 아이콘 컴포넌트나 이미지 경로로 대체
  },
  {
    year: "2024/08",
...
export default function About() {
  return (
    <>
      <Header />
      <div className="sm:ml-64 sm:mt-1 mt-20 overflow-hidden bg-white py-24 sm:py-32">
  <div className="mx-auto max-w-7xl px-6 lg:px-8">
    <div className="mx-auto grid max-w-2xl grid-cols-1 gap-x-8 gap-y-16 sm:gap-y-20 lg:mx-0 lg:max-w-none lg:grid-cols-2">
      ...
      <img
        src="https://tailwindui.com/img/component-images/project-timeline-screenshot.png"

...
export default function Profit() {
  ...
  const fetchProfitData = async () => {
    setLoading(true);
    try {
      const response = await axios.get(`${import.meta.env.VITE_APP_API_URL}/admin/profit/data`,{
        headers: { // 헤더는 여기에
  ...
  const fetchAllProfits = async () => {
    ...
    try {
      ...
      const response = await axios.get(`${import.meta.env.VITE_APP_API_URL}/admin/all`, {
  ...
  const fetchProfitsByMonth = async () => {
    ...
    try {
      const response = await axios.get(
        `${import.meta.env.VITE_APP_API_URL}/admin/month/${selectedYear}/${selectedMonth}`
        , {
          params: { // 여기에 쿼리 파라미터들을 넣어줘야 합니다.
  ...
  const fetchProfitsByDay = async () => {
    ...
    try {
      ...
      const response = await axios.get(
        `${import.meta.env.VITE_APP_API_URL}/admin/day/${year}/${month}/${day}`
        , {
          params: { // 여기에 쿼리 파라미터들을 넣어줘야 합니다.
